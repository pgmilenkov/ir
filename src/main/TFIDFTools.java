...
public class TFIDFTools {
	public static int getTinDNumber(String term, String contentField, IndexReader indexReader) {
	...
	public static double getTFIDF(String term, int docId, String contentField, IndexReader indexReader,
